...
st.set_page_config(page_title="TechAhead Advantage", layout="wide")
...
st.link_button("Click here to know more about AWS Well Architectured Framework practiced by TechAhead.", "https://www.techaheadcorp.com/blog/aws-well-architected-framework/")
